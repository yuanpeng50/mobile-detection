...
def parse_args(check=True):
    ...
    parser.add_argument(
      '--model_file',
      type=str,
      default='~/Desktop/my_project/frozen_graph.pb',
      help="""\
    ...
    parser.add_argument(
      '--label_file',
      type=str,
      default='~/Desktop/my_project/dataset/data_cars/labels.txt',
...
def main(_):
  ...
  run_inference_on_image('./object_detection/project/output/rfcn_resnet101_coco/0slice.jpg')
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--label_file',
      type=str,
      default='./project_data/labels.txt',
      help='Absolute path to label file.'
  )
  parser.add_argument(
      '--image_file',
